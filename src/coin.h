...
/**
 * Spins up and lands on face 1 or 2. The face is decided before the animation
 * starts and the animation is built to arrive there; reading a face off a spin
 * that stopped where it liked would bias the die.
 */
