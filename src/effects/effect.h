 ...
 * to the same rest; what differs is the way there. EFFECTS in effects.c is
 * what the effect setting indexes, so adding one is a file in this directory
 * defining an effect_t and a row in the table, and tests/reveal.c holds every
 * row to the promises below.
 */
