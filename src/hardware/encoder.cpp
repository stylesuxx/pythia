...
/**
 * The knob is a two-way switch. Each click pulls one line low for 6 to 100 ms,
 * A for clockwise and B for counter-clockwise, while the other line stays high.
 * Waveshare's own driver decodes it the same way, by polling.
 *
 ...
 * count again.
 *
 * NOTE: An edge interrupt cannot do this, because the level it reads after a
 *       bouncing edge lags the edge that fired.
 */
